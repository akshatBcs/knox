      ...
      <section className="container mt-5rem" id="tour">
        <div className="row flex-center-vh">
          ...
          <div className="col m6 s12">
            ...
            <p className="fs-1-2">
              knox is powered by Blockstack, an open-source, blockchain-based decentralized internet platform and app ecosystem that puts users in control of their identity and data. No company owns or controls Blockstack, it is independent.
              <br />
      ...
      <section className="container mt-5rem" id="how-it-works">
        <div className="row flex-center-vh hide-on-small-only">
          <div className="col m6 s12">
            ...
            <p className="fs-1-2">
              When you create a Blockstack account, you'll get a secret key that will encrypt everything that you do in the Blockstack app. Because of this, Blockstack or knox or anyone can't see or track your data. Your data can only be unlocked with the secret key that you own.
            </p>
            <p className="fs-1-2">
              So when you create a notebook in knox, it is encrypted by your secret key on your device itself and then saved on the <a href="#storage">cloud</a>. Without your secret key, no one can have access to your notebooks.
            </p>
            <p className="fs-1-2">
      ...
      <section className="container mt-5rem">
        <div className="row flex-center-vh hide-on-small-only">
          <div className="col m6 s12">
            ...
            <p className="fs-1-2">
              We loved building knox, so we set it free and even made it open-source whose codebase is available on <a href="#" target="_blank" rel="noopener noreferrer">GitHub</a>
